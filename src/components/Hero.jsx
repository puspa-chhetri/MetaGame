       ...
       <div id="video-frame" className="relative z-10 h-dvh w-screen overflow-hidden rounded-lg">
              <div>
                     ...
                     cursor-pointer overflow-hidden rounded-lg">
                      ...
                      transition-all duration-500 ease-in hover:opacity-100"
                      >
                       <video 
                       ref={nextVideoRef}
                    ...
                    <video
                     ...
                     muted
                     id="next-video"
                     className="absolute absolute-center invisible z-20 
              ...
              <div className="absolute left-0 top-0 z-40 size-full">
                <div className="mt-24 sm:px-10">
                  ...
                  <p className="mb-28 max-w-64 font-robert-regular text-blue-100">
